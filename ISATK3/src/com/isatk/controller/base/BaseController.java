...
public abstract class BaseController {
	...
	public static final String _DATAS_KEY = "dataSet";
	
	public static final String _SERVER_TIMESTAMP_KEY="serverTimestamp";
	
	public static final String _REQ_SRC_KEY="reqSrc";
